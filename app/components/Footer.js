          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4 mt-6">
              {['x', 'github', 'linkedin'].map((social) => (
                <div key={social} className="w-10 h-10 bg-gray-800 hover:bg-gray-700 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-purple-500/25">
