...
const AdminOrderAssignment = () => {
  ...
  return (
    ...
    //             <p className="text-sm text-gray-600">Assign orders to delivery personnel</p>
    //           </div>
    //         </div>
    //       </div>
    //     </div>
    ...
    //                 Area: <span className="font-medium capitalize">{order.shippingAddress?.city ?? '—'}</span>
    //               </span>
    //               <span className="text-gray-900 font-semibold">${order.totalPrice ?? 0}</span>
    //             </div>
    //             <div className="flex items-center space-x-2 text-sm text-gray-600">
    ...
    //                 <span className="text-sm font-medium text-blue-900">Assigned to {order.deliveryMan.name ?? '—'}</span>
    //               </div>
    //             </div>
    //           ) : (
    ...
    //                   <span className="text-sm font-medium text-yellow-900">Awaiting Assignment</span>
    //                 </div>
    //               </div>
    ...
    //           <p className="text-sm text-gray-600">Order #{String(selectedOrder._id).slice(-6)}</p>
    //         </div>

    //         <div className="p-6">
    //           <div className="space-y-4">
    //             {getAvailableDeliveryMen(selectedOrder.shippingAddress?.city ?? '').map((deliveryMan) => (
    //               <div key={deliveryMan._id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
    //                 <div className="flex items-center justify-between">
    //                   <div>
    //                     <h4 className="font-medium text-gray-900">{deliveryMan.name}</h4>
    ...
    //                     </p>
    //                     <p className="text-sm text-gray-600">Total Earnings: ${deliveryMan.deliverymanInfo?.earnings ?? 0}</p>
    //                   </div>
    //                   <button
    //                     onClick={() => assignDeliveryMan(selectedOrder._id, deliveryMan.email, deliveryMan._id)

    //                     }
    //                     className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors text-sm outline-2"
    //                   >
    //                     Assign
    //                   </button>
    //                 </div>
    ...
    //                 <h4 className="text-lg font-medium text-gray-900 mb-2">No Available Delivery Personnel</h4>
